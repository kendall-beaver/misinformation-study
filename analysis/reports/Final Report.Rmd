...
This report is organized and presented in four main sections: I. Categorical Responses for QQ1 - QQ3; II. Composite Score for QQ1 - QQ3; III. Sentiment Analysis of Ads; and IV. Future Work.
...
As mentioned in the Introduction, a composite score was developed to objectively measure how much a participant's response increased or decreased after being presented with an ad. This score was first used to quantify how much a response remained the same, in which an arbitrary range from -25% to 25% was chosen to encapsulate a participant keeping the same amount of thoughts with some flexibility, because it's impractible to expect someone to memorize and use the exact number of words and sentences as before the ad.

These results are presented in Table 1, where the ad that appears to have little affect on changing the responses was the control ad - audio group for QQ2, where 76.2% of responses remained unchanged. In contrast, the most amount pf responses that had the least amount of change was the for same ad, but for the visual group in QQ3, where 31.8% of the responses remained unchanged.
...
The categories that were created in the main sections throughout this report can be used to form categorical responses of questions that ask similar themes, although the 9 categories in QQ1 should be reduced to the same number of QQs 2 & 3, which had 6 and 4 categories, respectively.

One of the limitations of the categories presented here is that they were determined by one person, although with great consideration and critical thought, but at least one more annotator should assess and form categories and have the results compared to have a more objective list of categorical responses.

Even if the optimal amount of categories are identified and responses chosen for those categories, the ad may not have an impact on the responses unless a more direct message is conveyed through the dialogue. (If a different advertisement was presented to participants then the views may or may not change based on the emotional impact an ad may have.) Otherwise, the categorical responses will best be served as preliminary questions in the survey to collect thoughts and ideas of information literacy prior to being presented with an ad.

The original R markdown file of this report and all of its code to produce the graphs are located <https://github.com/kendall-beaver/misinformation-study>, along with all data pertaining to the original study, which the PI and undergraduate researcher only have access to. I would also like to express my gratitude to these two people for guiding me and making this project possible. My information literacy and knowledge about the topic has significantly improved because of their guidance throughout this interesting project, and I'm grateful for such a unique experience.
