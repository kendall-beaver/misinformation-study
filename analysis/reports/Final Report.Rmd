...
```{r one, tidy=TRUE, message=FALSE, warning=FALSE, results='hide', echo=FALSE}

### STANDALONE PLOT FOR CONTROL + TEST GROUPS ###
...
# Step 4: Split into Control and Test groups
...
Number 6 & 9 had some interesting trends, too.
