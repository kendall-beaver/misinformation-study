...
Moving onto the gender findings, it must first be noted that only females and males were included in this analysis because the third category, "prefer not to say", only made up 2% of participants, and the responses heavily skewed the data.

Based on these two genders, females are three times more likely than men to “tell the truth over supporting friends", as shown below in Figure 6. In constrast, males were 44% more likely than females to “protect their friends." Besides this, each gender kept the same views pre- and post-ad, to about the same percentage, that it's okay to tell a white lie to protect a friend.
