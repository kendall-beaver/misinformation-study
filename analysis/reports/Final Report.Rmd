...
The second largest category for the control ad was Category 5 ("Believe group can make their life better") before the ad, then was tied and shared equally with Category 6 ("Group seems large, powerful and different; could be fun") after the ad.
...
6 main themes were identified for QQ2 and appeared for all groups except for Category 4 ("Unsure"), which only appeared once for the test ad - visual group (Fig. 4).
...
Consistent across all ads is the first three groups taking the top three places for all ad groups, but in different variations.
