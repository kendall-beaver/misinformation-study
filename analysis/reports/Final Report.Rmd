...
ARQs 1 & 2 was easy to determine the sentiment that a participant felt because the question poses that sentiment from the participant, while ARQs 3 & 4 could express any sentiment, therefore these latter two required the most consideration and critical analysis to determine the sentiment. A new category called "SENTIMENT" was created that categorized the overall sentiment that expressed most frequently from ARQs 1-4, and was composed of 3 categories: Positive, Neutral, and Negative.

The categories have been plotted in Figure 7 and reveal that the control audio ad performed the worse out of all ad groups, 19.05%, followed by the test audio ad at 14.29%. This aligns with an additional analysis that looked at how many participants listen to podcast and skip past ads: Less than half of participants (47.5%) listen to at least one podcast and out of those listeners, 71.8% always skip the ads vs. 1.4% who say they never skip ads. It could be that participants in the audio format groups already had a bias and predisposition of wanting to skip past those ads.
...
In contrast, the test visual ad performed was reported to have the highest positive sentiment, with 82.14%, and in second place, the control visual ad had a 77.27% positive sentiment associated with it. The control audio ad received about half of the positive sentiment, 38.10%, indicating that participants strongly prefer visual over audio ads.
...
The github repo where this report and all accompanying data can be found is located at
