...
Figures 1 & 2 below show the results of a change in these categories.
...
caption <- textGrob("Figure 1: Control Group Responses Before and After the Ad", 
                    gp = gpar(fontsize = 10))
...
# Step 6: Create the caption text
caption <- textGrob("Figure 2: Control Group Responses Before and After the Ad", 
                    gp = gpar(fontsize = 10))
...
The largest category for both ad groups was Category 4 ("Confirmation bias"), which composed over 40% of all responses for participants. However, this response decreased on average by 7.07% after the control ad was presented, whereas the responses increased on average by 28.21% after the test ad was viewed and listened by those participants.

In the latter ad, a female character named Mel finds a group of online friends who want to storm the post office, but in the former ad, a female character named Jessica doesn't say or indicate that her in-person friends are radical, just that they're early bowlers. It's possible that the ad with radical, online friends could have influenced the responses, but more data and follow-up interviews would need to be conducted to validate this claim.

The second largest category for the control ad started off as Category 5 ("Believe group can make their life better"), but shared second place with Category 6 ("Group seems large, powerful and different; could be fun"). The second place for the test ad was mixed, where Categories 2, 1, 3, 6 & 9 alternated the spot for second place.
