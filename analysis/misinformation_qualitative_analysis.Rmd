...
# Change in QQ1 Answer After Seeing Visual Ad - Test vs. Control Group
...
# Change in QQ1 Answer After Seeing Audio Ad - Test vs. Control Group
...
## Change in QQ1 Comment Length After Seeing *Visual* Ad - Test vs. Control Group
...
stacked_bar_chart <- ggplot(stacked_data, aes(x = GROUP, y = percentage, fill = CHANGED_LENGTH_QQ1)) +
  ...
  labs(
    title = "Change in QQ1 Comment Length After Exposed to Ad",
    x = "\nGroup",
    y = "Percentage\n",
    fill = "Comment Length"
  ) +
...
# Change in QQ1 Comment Length After Seeing *Audio* Ad - Test vs. Control Group
