...
```{r histograms, tidy=TRUE, message=FALSE, warning=FALSE, results='hide', echo=FALSE}
...
# Pie Charts - Visual Ad (Test vs. Control Group)
...
grid.arrange(
  ...
  shared_legend,
  nrow = 2,
  heights = c(5, 2)  # Adjust height ratios for better spacing
)
```

# Pie Charts - Audio Ad (Test vs. Control Group)
