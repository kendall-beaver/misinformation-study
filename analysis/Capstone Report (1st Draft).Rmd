...
# Assuming your categories in `GROUP` are, for example: "A", "B", "C", "D"

categories <- unique(lying$GROUP)  # Get unique category names
...
for (category in categories) {
  ...
  print(p)  # Print the plot for this category
}
