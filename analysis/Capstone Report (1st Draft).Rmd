...
## QQ1: Categorical Data Before

```{r categorical_data_before, tidy=TRUE, message=FALSE, warning=FALSE, results='hide', echo=FALSE}


```

## QQ1: Categorical Data After

```{r categorical_data_after, tidy=TRUE, message=FALSE, warning=FALSE, results='hide', echo=FALSE}
