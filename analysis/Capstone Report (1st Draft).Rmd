...
## **QQ1 - Change in Length of Answers (Avg. Words Per Sentence)**
...
range(lying$QQ1_DIFFERENCE_AVG_WORDS_PER_SENTENCE)
# -114   55

# Normalize the data
lying$QQ1_DIFFERENCE_WORD_COUNT_Z <- scale(lying$QQ1_DIFFERENCE_WORD_COUNT)

# Apply bins
lying$change_category <- cut(
  lying$QQ1_DIFFERENCE_WORD_COUNT_Z,
  breaks = c(-Inf, -1.5, -0.5, 0.5, 1.5, Inf),
  labels = c("Significant decrease", "Moderate decrease", "Little to no change", "Moderate increase", "Significant increase")
)

hist(lying$QQ1_DIFFERENCE_WORD_COUNT_Z, 
     breaks = 30, 
     main = "Distribution of Z-Scores", 
     xlab = "Z-Score", 
     col = "lightblue")

abline(v = 0, col = "red", lwd = 2)  # Add vertical line at zero

plot(density(lying$QQ1_DIFFERENCE_WORD_COUNT_Z), 
     main = "Density Plot of Z-Scores", 
     xlab = "Z-Score")

abline(v = 0, col = "red", lty = 2, lwd = 2)  # Red dashed line at zero

boxplot(lying$QQ1_DIFFERENCE_WORD_COUNT_Z,
