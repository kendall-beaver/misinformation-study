...
# Step 2: Count and calculate percentages for all Genders
...
plot <- ggplot(lie_counts, aes(x = QuestionType, y = perc, fill = Response)) +
  ...
  # No facet by Gender (combine all Genders)
...
The responses stayed nearly identical. This section was easier to create categories out of than QQ1.
...
## QQ2: Categorical Data Before & After, All Gender & Categorical Genders
